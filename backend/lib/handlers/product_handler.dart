    ...
    try {
      ...
      final rows = productsData.map((p) {
        ...
        return ProductImportRow(
          ...
          boxPriceJpy: (item['boxPriceJpy'] as num?)?.toDouble(),
          noShrinkPriceJpy: (item['noShrinkPriceJpy'] as num?)?.toDouble(),
          casePriceJpy: (item['casePriceJpy'] as num?)?.toDouble(),
          boxPriceUsd: (item['boxPriceUsd'] as num?)?.toDouble(),
          boxPriceUsdWithTariff: (item['boxPriceUsdWithTariff'] as num?)?.toDouble(),
          noShrinkPriceUsd: (item['noShrinkPriceUsd'] as num?)?.toDouble(),
          noShrinkPriceUsdWithTariff: (item['noShrinkPriceUsdWithTariff'] as num?)?.toDouble(),
          casePriceUsd: (item['casePriceUsd'] as num?)?.toDouble(),
          casePriceUsdWithTariff: (item['casePriceUsdWithTariff'] as num?)?.toDouble(),
          category: item['category'] as String?,
          specifications: item['specifications'] as String?,
          notes: item['notes'] as String?,
          quoteRequired: item['quoteRequired'] as bool? ?? false,
        );
      }).toList();
